...
- a session-only review step that lets users mark actionable draft requirements and follow-up work as Proposed or Set aside while keeping formal approval separate
