...
export default async function WorkspaceProjectFilesPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <WorkspaceDefinitionView workspace={workspace} view="project-files" />;
}
