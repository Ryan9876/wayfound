...
requireText(component, 'Durable project AI review remains local-only', 'durable-boundary disclosure');
requireText(frame, '<AiDevelopmentConsole', 'console workspace integration');
